...
char a[69]="qwertyuiopasdfghjklzxcvbnmйцукенгшщзхъфывапролджэ€чсмитьб0123456789!";
//---------------------------------------------------------------------------
...
void __fastcall TForm3::Button1Click(TObject* Sender)
{
	...
	if (!chek1) {
		ShowMessage("был введен непраильный символ");
		return;
	}
    if (Edit1->Text != "" && Edit2->Text != "") {
        ...
        ShowMessage("введен неверный логин либо пароль");
    }
}
//---------------------------------------------------------------------------
	...
	if (Edit1->Text != "") {
        ...
        for (int i = 1; i <= Edit1->Text.Length(); i++) {
			for (int j = 0; j < 69; j++)
			{
				...
				if(!chek)
				{
				ShowMessage("Ѕыл введен неправильный символ");
